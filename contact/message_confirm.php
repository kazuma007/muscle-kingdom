<?php
  ...
  if (!empty($_POST)){
    ...
    $sql = 'INSERT INTO `messages` SET  `name`=?,
                                    `email`=?,
                                    `message`=?,
                                    `created`=NOW()';

    $data = array($_SESSION['contact']['name'], $_SESSION['contact']['email'], $_SESSION['contact']['message']);
  ...
  <div id="fh5co-page">
    ...
    <div id="fh5co-main">
      ...
      <div class="fh5co-narrow-content animate-box" data-animate-effect="fadeInLeft">
        ...
        <div class="row">
          <div class="col-md-6">
            <h2>THANKS FOR YOUR MESSAGE.<br>
            WE WILL GET BACK TO YOU LATER!</h2>
          </div>
        </div>
      </div>
    </div>
